...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel("Любимые", R.drawable.ic_add, ToolType.STICKER));
        mToolList.add(new ToolModel("Кадры", R.drawable.ic_frame, ToolType.FRAMES));
        mToolList.add(new ToolModel("Речь", R.drawable.ic_chat, ToolType.BUBBLE_SPEECH));
        mToolList.add(new ToolModel("Фильтр", R.drawable.ic_filter, ToolType.FILTER));
