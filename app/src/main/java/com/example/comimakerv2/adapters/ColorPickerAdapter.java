...
public class ColorPickerAdapter extends RecyclerView.Adapter<com.example.comimakerv2.adapters.ColorPickerAdapter.ViewHolder> {
    ...
    public static List<Integer> getDefaultColors(Context context) {
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.OrangeRed));
        ...
        colorPickerColors.add(ContextCompat.getColor(context, R.color.SkyBlue));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.Violet));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.white));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.Yellow));
        colorPickerColors.add(ContextCompat.getColor(context, R.color.YellowGreen));
